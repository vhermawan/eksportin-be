<?php namespace App\Http\Controllers;
	...
	class AdminBuyersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kategori","name"=>"id_category_buyers","join"=>"category_buyers,name"];
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
				$buyer = Buyer::find($id);
				$buyer->id_cms_users = CRUDBooster::myId();
				$buyer->slug = str_slug($buyer->name);
				$buyer->save();
	    }
