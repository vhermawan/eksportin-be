<?php namespace App\Http\Controllers;
	...
	class AdminCoursesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kategori","name"=>"id_category_courses","join"=>"category_courses,name"];
			$this->col[] = ["label"=>"Pemateri","name"=>"id_speakers","join"=>"speakers,name"];
	        ...
	        */
	        ...
	        | 
	        */
	        $this->addaction[] = ['url'=>CRUDBooster::mainpath('course-umkms/[id]'),'icon'=>'fa fa-users','color'=>'warning'];
	    ...
	    */
		...
		public function getIndexUmkmCourse() {
			//First, Add an auth
			if(!CRUDBooster::isView()) CRUDBooster::redirect(CRUDBooster::adminPath(),trans('crudbooster.denied_access'));
			//Create your own query 
			$data = [];
			$data['page_title'] = 'Peserta Materi';
			$data['result'] = DB::table('course_umkms')->orderby('id','desc')->paginate(10);
			
			// dd($data);
			//Create a view. Please use `view` method instead of view method from laravel.
			return $this->view('umkmCourse',$data);
		}
